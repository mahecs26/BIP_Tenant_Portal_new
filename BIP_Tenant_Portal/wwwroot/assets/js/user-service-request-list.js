                ...
                columns: [
                    {
                        'data': 'queryID', 'render': function (queryID, type, row, meta) {
                            if (row['status'] == 'Resolved') {
                                return '<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#acceptConfirmationModal" data-id="' + queryID + '">Accept</button>&nbsp;<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#reopenConfirmationModal" data-id="' + queryID + '">Reopen</button>&nbsp;<a href="' + PortalBaseUrl + '/UserServiceRequest/DetailedView/' + queryID + '" class="btn btn-primary btn-sm" target="_blank">View</a>';
                            }
                            else {
                            ...
                            //return '<a href="' + PortalBaseUrl + '/UserServiceRequest/DetailedView/' + queryID + '" class="btn btn-primary btn-sm">View</a>';
                        }
                    },
